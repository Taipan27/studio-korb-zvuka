...
- **ЛР1** — определены требования к системе и сценарии использования.
- **ЛР2** — построена иерархическая структура работ (WBS), на её основе
  выбраны элементы 3.2.1–3.2.5 для реализации в текущем инкременте.
- **ЛР3 (данная работа)** — реализован рабочий прототип, демонстрирующий
  5 ключевых функций системы.

## Что не вошло в текущий прототип (следующие итерации)

- Отгрузка релизов (WBS 3.2.4).
- Интеграция платёжной системы (WBS 3.2.5 — модуль предоплаты).
- Уведомления о бронировании по e-mail/SMS.
- Мониторинг релизов в личном кабинете.
- Графический график занятости студии для администратора.
